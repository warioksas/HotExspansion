...
public class Nustatymai extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> medadapter = new ArrayAdapter<String>(Nustatymai.this,R.layout.support_simple_spinner_dropdown_item, Medziagos);
